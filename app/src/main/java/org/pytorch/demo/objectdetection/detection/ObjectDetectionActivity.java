...
public class ObjectDetectionActivity extends AbstractCameraXActivity<ObjectDetectionActivity.AnalysisResult> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tracker = new FallbackLocationTracker(ObjectDetectionActivity.this);
    ...
    protected AnalysisResult analyzeImage(ImageProxy image, int rotationDegrees) {
        ...
        final ArrayList<Result> results = PrePostProcessor.outputsToNMSPredictions(outputs, imgScaleX, imgScaleY, ivScaleX, ivScaleY, 0, 0, bitmap, tracker.getLocation());
